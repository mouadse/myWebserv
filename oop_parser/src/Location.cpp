...
Location::Location()
    : _path(""), _root(""), _autoindex(false), _index(""), _methods(5, 0),
      _return(""), _alias(""), _client_max_body_size(kDefaultMaxBodySize) {}
...
Location::Location(const Location &other)
    : _path(other._path), _root(other._root), _autoindex(other._autoindex),
      ...
      _alias(other._alias), _cgi_path(other._cgi_path),
...
void Location::setPath(const std::string &parameter) { _path = parameter; }
...
static std::string dropSemicolonIfAny(std::string value,

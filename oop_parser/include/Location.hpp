 ...
 *
 * This class handles settings for a specific URL path (location) within a
 * server. It includes allowed methods, root directory, redirection, CGI
 * settings, etc.
 */
class Location {
private:
  ...
  unsigned long
      _client_max_body_size; ///< Max client body size for this location

public:
  std::map<std::string, std::string>
      _ext_path; ///< Map of extension to CGI executable path
